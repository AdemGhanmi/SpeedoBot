...
class _ImageEnhancerScreenState extends State<ImageEnhancerScreen> {
  ...
  Future<void> _downloadImage(String imageUrl) async {
    ...
    try {
      ...
      String fileName =
          'enhanced_image_${DateTime.now().millisecondsSinceEpoch}.jpg';
      ...
      await dio.download(imageUrl, savePath,
        ...
        if (total != -1) {
          print(
              'ImageEnhancerScreen: Téléchargement - Progrès: ${(received / total * 100).toStringAsFixed(0)}%');
        }
      });
  ...
  void _startEnhancement() async {
    ...
    try {
      ...
      if (imageUrl != null) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (mounted && _imageKey.currentContext != null) {
            ...
            if (renderBox != null) {
              ...
              print(
                  'ImageEnhancerScreen: Défilement vers position: $scrollPosition');
            } else {
        ...
        print(
            'ImageEnhancerScreen: Échec - URL de l\'image améliorée est null');
      }
    } catch (e) {
      setState(() {
        _isGenerating = false;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _buildActionButton(), // زر التحسين
                      ),
                      if (_isGenerating) ...[
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              width: double.infinity, // خليه يتوسع
                              height: 50,
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          onTap: _isGenerating
              ? null
              : _pickImage, // Désactive la sélection d'image si _isGenerating est vrai
          child: Container(
            height: 200,
  ...
  Widget _buildActionButton() {
    return GestureDetector(
      onTap:
          (_isGenerating || _selectedImage == null) ? null : _startEnhancement,
      child: AnimatedContainer(
        duration: Duration(milliseconds: 300),
        width: 180,
        height: 50,
