...
class _GenerateImageScreenState extends State<GenerateImageScreen> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                        child:
                            _buildActionButton(), // زر Generate ياخذ نص المساحة المتاحة
                      ),
                      if (_isGenerating) ...[
                  ...
                  if (_showGenerated && _generatedImageUrl != null)
  ...
  Widget _buildActionButton() {
    return GestureDetector(
      onTap: _isGenerating
          ? null
          : _startGeneration, // Désactive le bouton si _isGenerating est vrai
      child: AnimatedContainer(
