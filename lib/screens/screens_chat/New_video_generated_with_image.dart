...
class VideoGeneratedWithImageScreen extends StatefulWidget {
  @override
  State<VideoGeneratedWithImageScreen> createState() =>
      _VideoGeneratedWithImageScreenState();
}

class _VideoGeneratedWithImageScreenState
    extends State<VideoGeneratedWithImageScreen> {
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child:
                          _buildActionButton(), // زر Generate ياخذ نص المساحة
                    ),
                    if (_isGenerating) ...[
    ...
    return Column(
      children: [
        ElevatedButton(
          onPressed: _isGenerating
              ? null
              : _pickAudio, // Désactive la sélection d'audio si _isGenerating est vrai
          style: ElevatedButton.styleFrom(
            backgroundColor: textColor,
            padding: const EdgeInsets.symmetric(horizontal: 30, vertical: 15),
          ),
  ...
  Widget _buildActionButton() {
    return GestureDetector(
      onTap: (_isGenerating || _selectedImage == null || _selectedAudio == null)
          ? null
          : _startGeneration,
      child: AnimatedContainer(
